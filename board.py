...
class Board:
	...
	def move_piece(self, from_square, to_square):
		...
		if self.board[to_row][to_col] == '0': # move to empty square
		...
		# update castling rights (Can this be improved?, need to check when False?)
		if piece.lower() == 'k':
			if from_row == 0:
			...
			if from_row == 0:
				...
				if from_col == 0:
					...
					self.black_castleK = False
		# pawn promotion (improve this, efficiency and option to choose piece?)
